...
- [ ] Create `tests/test_cases/tests/test_functional_identity.py`

## 3. Update QNX Integration Tests
- [ ] Update `tests/integration_test_scenarios/BUILD` to stage demo binaries
- [ ] Update `tests/integration_test_scenarios/init_rpi4.build` to include demos
- [ ] Update `tests/integration_test_scenarios/kvs_test.sh` to run demos and verify

## 4. Add PR Automation
- [ ] Create `.github/workflows/ci.yml` for PR automation
